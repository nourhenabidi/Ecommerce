...
function PrivacyPolicy() {
  return (
    ...
    <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-4 text-orange-900">Privacy Policy</h1>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">Information We Collect</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">How We Use the Information</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">Security</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">Cookies</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">Links to Other Websites</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 text-orange-900">Controlling Your Personal Information</h2>
